---
name: sales
description: AI Sales Team orchestrator. Use when the user runs /sales <subcommand> (prospect, quick, research, qualify, contacts, outreach, followup, prep, proposal, objections, icp, competitors, report, report-pdf) for B2B sales prospecting, research, qualification, outreach, and reporting from the command line.
---
